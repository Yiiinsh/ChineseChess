...
public class GameControllerTest {
    ...
    public void testInitPieces() {
        ...
        for(String key : gc.initPieces().keySet()) {

            Assert.assertNotEquals(null, pieces.get(key));
        }
    ...
    public void testHasWin() {
         ...
         * TC1.168
         */
        Assert.assertEquals(gc.hasWin(board), 'x');
        /**
         * TC1.169
         */
        board.pieces.remove("bb0");
        Assert.assertEquals(gc.hasWin(board), 'r');
        /**
         * TC1.170
         */
        board = Rules.initBoard();
        board.pieces.remove("rb0");
        Assert.assertEquals(gc.hasWin(board), 'b');
